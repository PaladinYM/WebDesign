...
@RestController //声明这是一个控制器类，并且是Restful api的控制器，这个控制器可以自动进行数据格式转换
//可以将java的对象类型转换成JSON格式发送给前台
@RequestMapping("/api/main")    //配置了控制器映射的请求前缀
public class MainController {
    ...
    @GetMapping("good") //完整的路径是/api/main/good
